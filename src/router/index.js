...
export const asyncRoutes = [
  {
    ...
    children: [
      {
        path: 'org',
        component: () => import('@/views/system-mgr/org/index'),
        name: 'sys_mgr_org',
        meta: {
          title: '组织/部门',
      ...
      {
        path: 'user',
        component: () => import('@/views/system-mgr/user/index'),
        name: 'sys_mgr_user',
        meta: {
          title: '用户'
      ...
      {
        path: 'role',
        component: () => import('@/views/system-mgr/role/index'),
        name: 'sys_mgr_role',
        meta: {
          title: '角色'
          // if do not set roles, means: this page does not require permission
